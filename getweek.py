...
WEEKDAY = IntEnum('WEEKDAY', 'MON TUE WED THU FRI SAT SUN', start=5)
...
if __name__ == '__main__':
    ...
    # print(my_calendar.calculate(datetime(2020, 3, 6)))


my_calendar = CustomizedCalendar(start_weekday=WEEKDAY.FRI)
s = datetime(2020, 1, 1)
...
for I in range(35):
    print(str(my_calendar.calculate(s)))
    # offsetdt = dt + timedelta(days=i)
    # wknum = myweeknum(offsetdt)
    # print(str(datetime.date(offsetdt)) + ' Week - ' + str(wknum - 1))
    s+= timedelta(days=1)